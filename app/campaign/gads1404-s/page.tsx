	...
	return (
		...
		>
			...
			<a
				...
				className="bg-[#0934f1] rounded-2xl flex flex-col items-center justify-center py-4 max-w-[80%] mx-auto gap-2 absolute left-0 right-0 sm:max-w-[420px] gelatine cursor-pointer hover:opacity-95 transition-opacity bottom-4 sm:bottom-40"
			>
