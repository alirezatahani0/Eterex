		...
		<main>
			...
			<BrandTicker
				logos={[
					...
					{
						src: '/assets/partners/BlockchainAssociation.png',
						alt: 'انجمن بلاکچین',
						width: 64,
						height: 64,
						text: 'انجمن بلاکچین',
					...
					{
						src: '/assets/partners/FintechAssociation.png',
						alt: 'انجمن فینتک',
						width: 64,
						height: 64,
						text: 'انجمن فینتک',
					...
					{
						src: '/assets/partners/RasalatBank.png',
						alt: 'بانک رسالت',
						width: 64,
						height: 64,
						text: 'بانک رسالت',
					...
					{
						src: '/assets/partners/TourismBank.png',
						alt: 'بانک گردشگری',
						width: 64,
						height: 64,
						text: 'بانک گردشگری',
					...
					{
						src: '/assets/partners/NationalBank.png',
						alt: 'بانک ملی',
						width: 64,
						height: 64,
						text: 'بانک ملی',
					...
					{
						src: '/assets/partners/Zibaeel.png',
						alt: 'زیبال',
						width: 64,
						height: 64,
						text: 'زیبال',
					...
					{
						src: '/assets/partners/Finnotech.png',
						alt: 'فینوتک',
						width: 64,
						height: 64,
						text: 'فینوتک',
					...
					{
						src: '/assets/partners/ComputerIndustryAssociation.png',
					...
					{
						src: '/assets/partners/Vandar.png',
						alt: 'وندار',
						width: 64,
						height: 64,
						text: 'وندار',
