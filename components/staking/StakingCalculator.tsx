...
export default function StakingCalculator() {
	...
	return (
		<div
			className="relative w-full flex flex-col lg:flex-row-reverse justify-center lg:justify-between items-center gap-6 p-6 self-stretch rounded-[36px] border-2 border-grayscale-03 lg:container lg:m-auto"
			style={{
				background:
		...
		>
			...
			<div className="flex justify-center mb-6">
				<Image
					src="/assets/staking/calculator.png"
					alt="calculator"
					width={152}
					height={152}
			...
			<div className="flex flex-col justify-center items-center lg:items-start gap-6 lg:w-2/3 w-full">
				...
				<div className="text-center lg:text-right! mb-8">
					<Text variant="Main/24px/Bold" className="text-grayscale-07! lg:font-bold lg:text-[32px] lg:leading-[48px]">
						محاسبه{' '}
				...
				<div className="flex flex-row items-center justify-between gap-2 w-full ">
					...
					<div className="relative lg:w-full">
						<input
							...
							className="w-full h-15 px-2 bg-glass-white-1 rounded-[40px] border border-grayscale-03 text-grayscale-07 text-xl font-semibold text-center focus:outline-none focus:border-brand-primary"
							placeholder="1000"
						/>
