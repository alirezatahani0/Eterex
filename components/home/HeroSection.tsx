...
export default function HeroSection() {
	...
	return (
		<>
			<div
				className={cn(
					'bg-cover bg-center bg-no-repeat h-[calc(100vh-89px)] lg:hidden',
			...
			<Container className="hidden lg:flex relative z-10 py-12 md:py-16 lg:py-20 h-[656px] xl:h-[720px]">
				<div
					className={cn(
						'bg-cover bg-center bg-no-repeat h-full pr-[96px] ',
						'flex flex-col items-start justify-center border-2 border-grayscale-03 rounded-3xl pl-[50%]',
						"bg-[url('/assets/main/Header.png')] md:bg-[url('/assets/main/Header-MD.png')] lg:bg-[url('/assets/main/Header-LG.png')] 2xl:bg-[url('/assets/main/Header-XL.png')]",
					)}
				>
					{/* Tagline */}
