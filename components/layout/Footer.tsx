		...
		<footer className="border-t border-grayscale-03 lg:border-none pt-14 pb-7 lg:pb-0 bg-white">
			<Container className="flex flex-col gap-20 lg:grid lg:grid-cols-[1fr_2fr] lg:pl-0 relative">
				...
				<div className="flex flex-col gap-10 md:hidden">
					<Collapse
						header={footer.educationNews.title}
						contentClassName="flex flex-col gap-2"
					>
						<Link href="/login">
							<Text variant="Main/14px/SemiBold" color="#808080">
								{footer.educationNews.latestNews}
							</Text>
						</Link>
						<Link href="/login">
							<Text variant="Main/14px/SemiBold" color="#808080">
								{footer.educationNews.advancedTrading}
							</Text>
						</Link>
						<Link href="/login">
							<Text variant="Main/14px/SemiBold" color="#808080">
								{footer.educationNews.depositWithdrawal}
							</Text>
						</Link>
						<Link href="/login">
							<Text variant="Main/14px/SemiBold" color="#808080">
					...
					<Collapse
						header={footer.guideSupport.title}
						contentClassName="flex flex-col gap-2"
					>
						<Link href="/login">
							<Text variant="Main/14px/SemiBold" color="#808080">
								{footer.guideSupport.onlineSupport}
							</Text>
						</Link>
						<Link href="/login">
							<Text variant="Main/14px/SemiBold" color="#808080">
								{footer.guideSupport.fees}
							</Text>
						</Link>
						<Link href="/login">
							<Text variant="Main/14px/SemiBold" color="#808080">
								{footer.guideSupport.identityVerification}
							</Text>
						</Link>
						<Link href="/login">
							<Text variant="Main/14px/SemiBold" color="#808080">
								{footer.guideSupport.blog}
							</Text>
						</Link>
						<Link href="/login">
							<Text variant="Main/14px/SemiBold" color="#808080">
								{footer.guideSupport.faq}
							</Text>
						</Link>
					</Collapse>
					<Collapse
						header={footer.aboutEterex.title}
						contentClassName="flex flex-col gap-2"
					>
						<Link href="/login">
							<Text variant="Main/14px/SemiBold" color="#808080">
								{footer.aboutEterex.security}
							</Text>
						</Link>
						<Link href="/login">
							<Text variant="Main/14px/SemiBold" color="#808080">
								{footer.aboutEterex.aboutUs}
							</Text>
						</Link>
						<Link href="/login">
							<Text variant="Main/14px/SemiBold" color="#808080">
								{footer.aboutEterex.contactUs}
							</Text>
						</Link>
						<Link href="/login">
							<Text variant="Main/14px/SemiBold" color="#808080">
								{footer.aboutEterex.rules}
							</Text>
						</Link>
						<Link href="/login">
							<Text variant="Main/14px/SemiBold" color="#808080">
								{footer.aboutEterex.userPanel}
							</Text>
						</Link>
					</Collapse>
				</div>

				<div className="lg:col-start-2 lg:row-start-1 lg:row-end-2 lg:bg-dotted rounded-tr-[120px] lg:border-2 lg:border-grayscale-03">
					<div className="flex flex-col gap-20 lg:bg-[linear-gradient(130deg,rgba(235,158,42,0.27)_0%,rgba(15,52,244,0.09)_25%,rgba(255,255,255,1)_56%,rgba(15,52,244,0.14)_100%)] lg:py-[144px] lg:px-[76px] 2xl:pt-[128px] 2xl:pr-[156px] rounded-tr-[120px]">
						<div className="hidden md:grid grid-cols-3 gap-10 ">
							<div>
								<div className="flex-1 text-right text-2xl leading-9 text-[#000] mb-6">
									{footer.aboutEterex.title}
								</div>
